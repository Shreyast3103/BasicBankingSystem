...
<meta name="author" content="Shreyas T">
...
echo "<div class='customer-".$row["id"]."'>";
  echo  "<img src='images/Male.jpg' alt='Male Avatar' class='card-image' >";
